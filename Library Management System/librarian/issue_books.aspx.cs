...
namespace Library_Management_System.librarian
{
    public partial class issue_books : System.Web.UI.Page
    {
        ...
        protected void b1_Click(object sender, EventArgs e)
        {
            ...
            {
                //this is for checking student have this book already
                int found = 0;
                ...
                if (found > 0)
                {
                    Response.Write("<script>alert('This books is already available with this student');</script>");
                }
                else
                {

                    //this if for books available in stocks or not
                    if (instock.Text == "0")
                    {
