<%@ Page Title="" Language="C#" MasterPageFile="~/librarian/librarian.Master" AutoEventWireup="true" CodeBehind="display_all_books.aspx.cs" Inherits="Library_Management_System.librarian.display_all_books" %>
                ...
                <asp:Repeater ID="r1" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><a href="edit_books.aspx?id=<%#Eval("id")%>" class="btn btn-primary">Edit Books</a></td>
                            <td><a href="delete_files.aspx?id2=<%#Eval("id")%>" class="btn btn-danger">Delete Books</a></td>
                       </tr> 
                    </ItemTemplate>
