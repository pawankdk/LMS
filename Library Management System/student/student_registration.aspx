<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_registration.aspx.cs" Inherits="Library_Management_System.student.student_registration" %>
...
<head>
    ...
    <title>Central Library Kathmandu - Student Registration Form</title>
...
<body class="bg-dark">
            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form id="form1" runat="server">
                        ...
                        <asp:Button ID="b1" runat="server" class="btn btn-primary btn-flat m-b-30 m-t-30" Text="Registrer Now" OnClick="b1_Click" />
    ...
    <script type="text/javascript">
        var your_site_key = '6LdOuvcbAAAAAAvK-R_rpjjTW2n1H1RELSb2hpxp';
        var renderRecaptcha = function () {
            grecaptcha.render('ReCaptchContainer', {
                'sitekey': '6LdOuvcbAAAAAAvK-R_rpjjTW2n1H1RELSb2hpxp',
